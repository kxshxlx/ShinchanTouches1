 ...
 shinchan.velocityY = 0;
  ...
  if(gameState === "serve"){
   ...
   gameState = "play"; 
    ...
    if(touches.length=1 || mousePressedOver(SPACE)) {      
      serve();
      gameState = "play";
    ...
    if(mousePressedOver(R) && gameState === "end"){
      ...
      if(touches.length=1 || mousePressedOver(R)) {      
        shinchanS.stop();
        gameState = "serve";
        positionR();
        touches = []
  ...
  if(touches.length=1 || mousePressedOver(lArrow)) {      
    shinchan.velocityX= -5;
    touches = []
  }
  ...
  if(touches.length=1 || mousePressedOver(rArrow)) {      
    shinchan.velocityX= +5;
    touches = []
  }
  ...
  if(touches.length=1 || mousePressedOver(uArrow)) {      
    shinchan.velocityY= -5;
    touches = []
  }
  ...
  if(touches.length=1 || mousePressedOver(dArrow)) {      
    shinchan.velocityY= +5;
    touches = []
  }
